...
class WorkerMap(object):
    ...
    def add_worker(self, worker_id=str(random.random()),
                   mode='no_container',
                   worker_type='RAW',
                   # container_uri=None,  # TODO: removed via task_routing_soft
                   walltime=1,
                   address=None,
                   debug=None,
                   worker_port=None,
        ...
        logger.info("ZZ: Mode: {}".format(mode))
        logger.info("ZZ: Container uri: {}".format(container_uri))
        logger.info("ZZ: Worker type: {}".format(worker_type))
